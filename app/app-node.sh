...
app_install_node()
{
    ...
    git clone https://github.com/benchpay/benchcore-v1.git -b explorer "$SIDECHAIN_PATH"
    cd "$SIDECHAIN_PATH"
    ...
    sed -i -e "s/var db_name = \"benchpay_\" + network_name;/var db_name = \"$DATABASE_NAME\";/g" createGenesisBlock.js
    ...
    sed -i -e "s/6620/$NODE_PORT/g" createGenesisBlock.js
